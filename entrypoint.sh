...
if [[ "$1" == "before-destroy" ]]; then
    ...
    gh pr create --head tf_destroy_$2_$5 --base develop -t "[ Terraform destroy ]: Automatic PR opened by GitHub Actions" --body "[ Terraform destroy ]: Automatic PR opened by GitHub Actions"
